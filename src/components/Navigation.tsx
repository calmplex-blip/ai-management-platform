...
const navLinks = [
  ...
  { href: '/mcp-playground', label: 'MCP Playground' },
  { href: '/a2a-agents', label: 'A2A Agents' },
  { href: '/ap2-tasks', label: 'AP2 Tasks' },
            ...
            <div className="hidden sm:ml-8 sm:flex sm:space-x-1 overflow-x-auto">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`inline-flex items-center px-3 pt-1 border-b-2 text-sm font-medium whitespace-nowrap transition-colors ${
                    isActive(link.href)
